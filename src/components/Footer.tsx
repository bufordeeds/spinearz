    ...
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">SpinEarz</h3>
            <p className="text-gray-600 text-sm">
              Unique jewelry crafted from authentic fishing lures. Each piece tells a story.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/products" className="text-gray-600 hover:text-teal-600 text-sm">
                  All Products
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mb-2">
              Follow us for updates and new designs
            </p>
