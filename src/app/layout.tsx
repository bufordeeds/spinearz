...
export const metadata: Metadata = {
	...
	description:
		'Unique jewelry crafted from authentic fishing lures. Each SpinEarz piece transforms vintage fishing lures into wearable art.',
	keywords:
		'fishing lure earrings, unique jewelry, upcycled jewelry, fishing gifts, handmade earrings',
	openGraph: {
